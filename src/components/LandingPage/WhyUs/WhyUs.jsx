...
const WhyUs = () => {
  const icon1 = <SiWebmoney className=" text-black-500 mx-auto" size={48} />;
  const icon2 = <FaUsers className=" text-black-500 mx-auto" size={48} />;
  const icon3 = (
    <FaShippingFast className=" text-black-500 mx-auto" size={48} />
  );
