...
const FooterPages = () => {
  return (
    <section
      className={`${styles.flexCenter} ${styles.paddingY} flex-col bg-black `}
    >
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className="flex-[1] flex flex-col justify-start mx-10">
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
        ...
        {/* social icon lists */}
        <div className="flex flex-row md:mt-0 mt-6 mx-10">
